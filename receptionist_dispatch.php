...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $message=alertError();
              ...
              if(mysqli_query($conn,"UPDATE customer_order SET order_status ='Taken' WHERE idorder = '".$_POST['dispatch']."'")){
                $message=alertSuccess();
  }else{
    $message=alertError();
  }
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="text-blue" style="width: 140px;"><small>Action</small></th>
                </tr>
                </thead>
                <tbody>
                <?php
                $i=1;
                $clear_bill = '';
                 $query=mysqli_query($conn,"SELECT * FROM assign_order a, customer_order o,services s, customer c WHERE a.idorder = o.idorder AND a.idcustomer = c.idcustomer AND o.idcustomer = c.idcustomer AND o.idservice = s.idservice AND a.idsettings = $company_id AND o.order_status = 'Ready'");
                    while($row=mysqli_fetch_array($query)){
                      ?>
                      <tr>
                        <td><?php echo $i;?></td>
                        ...
                        <td><?php echo $clear_bill; ?><form action="" method="post"><button class="btn btn-primary pull-right" type="submit" name="dispatch" value="<?php echo $row['idorder'];?>">Dispatch</button></form></td>
