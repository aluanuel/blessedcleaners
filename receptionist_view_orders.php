  ...
  <div class="content-wrapper">
    ...
    $message='';            
            ...
            if(isset($_POST['save_task_assigned'])){
              ...
              $user_id = $_POST['washman'];
              if(mysqli_query($conn,"INSERT INTO assign_order(idorder,idcustomer,idusers,idsettings) VALUES($order_id,$customer_id,$user_id,$company_id)")){
                mysqli_query($conn,"UPDATE customer_order SET order_status ='Queued' WHERE idorder = $order_id");
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
           <div class="box-header">
            <h3 class="box-title">Showing customer received orders</h3>
            </div>
            <div class="box-header">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center text-primary">Task Assignment Form</h4>
            </div>
            <form action="" method="post">
                    ...
                    <div class="box-body">
                        <div class="row form-group">
                            <div class="col-xs-12">
                              ...
                              <input type="hidden" name="customer" value="<?php echo $row['idcustomer'];?>">
                                <label class="text-info">Select Washman</label>
                                <select class="form-control select2" name="washman" required style="width: 100%;">
                  <option >Select</option>
                  <?php 
                    $query_washman = mysqli_query($conn,"SELECT * FROM users WHERE usertype = 'cleaner' AND idsettings = $company_id");
                    if(mysqli_num_rows($query_washman)>0){
                      while($row = mysqli_fetch_array($query_washman)){

                  ?>
                  <option  value="<?php echo $row['idusers']?>"><?php echo $row['fname'].' '.$row['lname'];?></option>
                  <?php
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="save_task_assigned" class="btn btn-success btn-md">Save</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
