...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
    <?php
            $query=mysqli_query($conn,"SELECT * FROM assign_order a, customer_order o,users u,services s WHERE a.idorder = o.idorder and o.idservice = s.idservice AND a.idusers = u.idusers AND a.idsettings = $company_id ORDER BY o.order_date DESC");
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="text-blue"><small>Order</small></th>
